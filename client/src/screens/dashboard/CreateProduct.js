        ...
        <Wrapper>
            <ScreenHeader>
                <Link to={"/dashboard/products"} className='btn-dark'>
                    <i className='bi bi-arrow-left'></i>  products list</Link>
            </ScreenHeader>
                ...
                <form className="w-full xl:w-8/12 p-3" onSubmit={createPro}>
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full md:w-6/12 p-3">
                            ...
                            {!isFetching ? data.categories.length > 0 &&
                                <select name="category" id='categories' className="form-control"
                                    onChange={handleInput} value={state.category}>
                        ...
                        <div className="w-full p-3">
                            ...
                            <ReactQuill theme="snow" id="description" value={value} 
                            onChange={setValue} placeholder="Description..." />
                        </div>
                        <div className="w-full p-3">
                            <input type="submit" value={response.isLoading ? 
                            'Loading..' : 'save product'} disabled={response.isLoading ? true : false} className="btn btn-indigo"/>
                        </div>
                    </div>
                </form>
